package com.ashish.loans.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<ErrorResponseDto> handleCardAlreadyExistsException(LoanAlreadyExistsException ex, WebRequest req) {
